...
class DelayedDisplayState extends State<DelayedDisplay>
  ...
  /// Initialize controllers, curve and offset with given
  /// parameters or default values. Use a Timer in order to delay
  /// the animations if needed
  @override
  void initState() {
    super.initState();
  ...
  /// Whenever the widget is updated and that fadeIn is different from the
  /// oldWidget, triggers the fade in
  /// or out animation.
  @override
